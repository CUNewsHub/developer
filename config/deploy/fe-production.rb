...
set :slack_msg_updating,       -> { "#{fetch :slack_deploy_user} has started deploying branch #{fetch :branch} of front-end to the production-server" }

set :slack_msg_updated,       -> { "#{fetch :slack_deploy_user} has finished deploying branch #{fetch :branch} of front-end to the production-server" }
